...
It is as simple as installing `pyfea` via either pip install or setup-tools and than just running main.py in this folder. To change parameters use parameters.uiv and follow the .uiv standard notation if your changing element beyond their numerical values.